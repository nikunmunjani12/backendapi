...
class ApiGridviewcoll extends StatefulWidget {
  const ApiGridviewcoll({Key? key}) : super(key: key);

  @override
  State<ApiGridviewcoll> createState() => _ApiGridviewcollState();
}

class _ApiGridviewcollState extends State<ApiGridviewcoll> {
  var Data;
